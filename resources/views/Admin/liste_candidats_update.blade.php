...
<th><p style="color:black"  align="center">Score_théorique</p></th>
<th><p style="color:black"  align="center">Score_pratique</p></th>
...
<th><input type="text" readonly value="{{$project->firstname}}" style="color:black"  name="prenom" class="form-control mb-2 mr-sm-2"></th>
         ...
         @if($project->Num_ops==null)
         <th><input type="number"  style="color:black"   readonly value="{{$project->score_théorique}}"  name="score1" class="form-control mb-4 mr-sm-4"></th>
         <th><input type="number"  style="color:black"    readonly value="{{$project->score_pratique}}"  name="score2" class="form-control mb-4 mr-sm-4"></th>

         <th><a  href="{{route('modify_note1',['value'=>$project->id])}}" class="btn btn-lg btn-success btn-block " > Modifier Note </a></th>
         ...
         <th><a  href="{{route('modify_note1',['value'=>$project->id])}}" class="btn btn-lg btn-success btn-block disabled" > Modifier Note </a></th>
         @endif
