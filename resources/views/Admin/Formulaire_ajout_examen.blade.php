                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('save_exam')}}">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label for="contact" class="col-md-4 col-form-label text-md-right">{{ __('Tel') }}</label>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label for="type" class="col-md-4 col-form-label text-md-right">{{__('Type_Examen')}}</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <option value="0"> </option>
                                 ...
                                 <option value="1">Concours OPS</option>
                                  <option value="2">Test de mise à niveau</option>
