...
<div class="container">
    <div class="row justify-content-center" style="margin-left: -200px; margin-right:-200px ">
        <div class="col-md-24">
            <div class="card">
                <div class="card-header text-center" ><h1>Renseigner les informations sur la formation Externe ou vous vous êtes Inscrit
                </br>
                ...
                <div class="card-body">
                    ...
                    @endif
                     ...
                     <div class="card-body">
                    <form method="POST" action="{{route('pass_exam')}}">
                        @csrf
