...
<div class="container">
    <div class="row justify-content-center" style="margin-left: -400px; margin-right:-400px ">
        <div class="col-md-24">
            <div class="card">
                <div class="card-header text-center" ><h1>Liste des appels d'offres disponibles
...
<th><a  href="{{route('Choix_zone',['value'=>$project->	id])}}" class="btn btn-lg btn-success btn-block " onclick="return window.confirm('voulez-vous confirmer votre Disponibilité pour cet appel d'offre ?')" >Valider </a></th>
